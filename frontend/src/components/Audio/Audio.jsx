...
export default function AudioPlayer({ activeSound }) {
    ...
    useEffect(() => {
        ...
        const speed = 0.07;
        const squares = [
            { x: 9, y: 35, width: 3, height: -5, color: "#091429", dy: 0.7, max: -6 },
            { x: 14, y: 35, width: 3, height: -5, color: "#091429", dy: 2, max: -13 },
            { x: 19, y: 35, width: 3, height: -5, color: "#091429", dy: 3, max: -15 },
            { x: 24, y: 35, width: 3, height: -5, color: "#091429", dy: 1.6, max: -16 },
            { x: 29, y: 35, width: 3, height: -5, color: "#091429", dy: 1, max: -8 },
        ];
