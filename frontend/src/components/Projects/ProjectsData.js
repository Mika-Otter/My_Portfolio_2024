const projectsData = [
    ...
    // },
    {
        ...
        client: "Personnal",
        type: "website",
        img1: "./src/assets/img/project-dnsep/dnsep-1.webp",
        img2: "./src/assets/img/project-dnsep/dnsep-2.webp",
        img3: "./src/assets/img/project-dnsep/dnsep-3.webp",
        img4: "./src/assets/img/project-dnsep/dnsep-4.webp",
        img5: "./src/assets/img/project-dnsep/dnsep-5.webp",
        img6: "./src/assets/img/project-dnsep/dnsep-6.webp",
        img7: "./src/assets/img/project-dnsep/dnsep-7.webp",
        img8: "./src/assets/img/project-dnsep/dnsep-8.webp",
    },
    {
        title: "Typpov ",
        smalltext: " Tool",
        ...
        type: "website",
        img1: "./src/assets/img/project-typpov/inprogress.png",
        img2: "./src/assets/img/project-typpov/inprogress.png",
        img3: "./src/assets/img/project-typpov/inprogress.png",
        img4: "./src/assets/img/project-typpov/inprogress.png",
        img5: "./src/assets/img/project-typpov/inprogress.png",
        img6: "./src/assets/img/project-typpov/inprogress.png",
        img7: "./src/assets/img/project-typpov/inprogress.png",
        img8: "./src/assets/img/project-typpov/inprogress.png",
    },
    ...
    },
    {
        ...
        type: "website",
        img1: "./src/assets/img/project-unexpected/unexpected3.webp",
        img2: "./src/assets/img/project-unexpected/unexpected2.webp",
        img3: "./src/assets/img/project-unexpected/unexpected7.webp",
        img4: "./src/assets/img/project-unexpected/unexpected4.webp",
        img5: "./src/assets/img/project-unexpected/unexpected5.webp",
        img6: "./src/assets/img/project-unexpected/unexpected8.webp",
        img7: "./src/assets/img/project-unexpected/unexpected6.webp",
