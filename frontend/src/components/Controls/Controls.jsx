...
export default function Controls({ handleControls, isControls, closeProject }) {
    ...
    useKeyInteractAnimation(keyInteractRef, videoIsPlaying, keyRightRef, keyRightArrowRef, keyLeftRef, keyLeftArrowRef, keySpaceRef);
    useProjectAnimation(projectWrapperRef, projectRef, videoRef, isControls, closeProject, setVideoIsPlaying);
